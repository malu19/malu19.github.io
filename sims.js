...
botao1.onclick = function transformação(){
	...
	var resultado = "1 mol - 55,8 g <br> X mol - " + massa +" g <br> <br> 55,8 . X = 1 . " + massa + " <br> X = " + massa + "/" + " 55,8 <br> X = " + resultado + " mol(s). <br><br> " + massa + " g = " + resultado + " mol(s)";
...
botao2.onclick = function transformação2(){
	...
	var resultado = "55,8 g - 1 mol <br> X g - " + mol + " mol <br><br> 1 . X = 55,8 . " + mol + " <br> X = " + gramas*mol + "/1 <br> " + "X = " + resultado + " g <br><br> " + mol + " mol = " + resultado + " g";
